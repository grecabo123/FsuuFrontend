...
function ReadSent(props) {
    ...
    useState(() => {
        ...
        axios.get(`/api/SentItemsDataFaculty/${id}`).then(res => {
            ...
            <Panel headerTemplate={header}>
                <div className="col">
                    <div className="col-md-12 mb-2">
                        <InputText value={AllData.usersinfo.email} readOnly required className="form-control py-2" placeholder='To Recipient ' onChange={(e) => setTouser(e.target.value)} />
                    </div>
                    <div className="col-md-12 mb-2">
